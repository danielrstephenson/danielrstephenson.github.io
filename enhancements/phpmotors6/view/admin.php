	...
	<div id="wrapper">
		...
		<main>
			...
			<section>
				...
				<p class="margin1"><a href="/phpmotors6/accounts/?action=update">Update Account Information</a></p>
			</section>
			<?php
			...
			<h2 class="margin1">Inventory Management</h2>
				...
				<p class="margin1"><a href="/phpmotors6/vehicles/">Vehicle Management</a></p>
			<?php
			}
			?>
