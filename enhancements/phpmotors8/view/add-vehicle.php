 ...
 <div id="wrapper">
  ...
  <main>
   ...
   <label for="carClass">Classification</label>
    ...
    <input type="text" name="invImage" id="invImage" value="/phpmotors8/images/no-image.png" required 
    <?php if(isset($invImage)){echo "value='$invImage'";}  ?>>

    <label for="invThumbnail">Thumbnail Path</label>
    <input type="text" name="invThumbnail" id="invThumbnail" value="/phpmotors8/images/no-image.png" required 
