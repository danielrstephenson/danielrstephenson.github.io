    ...
    <body>
      <div id="wrapper">
        ...
        <main>
          ...
          <ul>
            <li><a href="/phpmotors7/vehicles/?action=class-page">Add Classification</a></li>
            <li><a href="/phpmotors7/vehicles/?action=vehicle-page">Add Vehicle</a></li>
          </ul>
      ...
      <script src="/phpmotors7/js/inventory.js"></script>
    </body>
