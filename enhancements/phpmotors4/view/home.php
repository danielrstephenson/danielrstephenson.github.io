  ...
  <main>
   ...
   <section id="hero">
    ...
    <ul>
     ...
     <li>Fuzzy dice!</li>
     <li><a href="/phpmotors4/cart/" title="cart"><img id="actionbtn" alt="Add to cart button" src="/phpmotors4/images/site/own_today.png"></a></li>
    </ul>
    ...
    <section id="add-ons">
     ...
     <div class="flex">
      <a href="#" title="flux-capacitor">
       <figure>
        ...
        <div class="add-col"><img src="/phpmotors4images/upgrades/flux-cap.png" alt="Flux-Capacitor"></div>
        <figcaption>Flux Capacitor</figcaption>
       </figure>
      </a>
      <a href="#" title="flame decals">
       <figure>
        <div class="add-col"><img src="/phpmotors4images/upgrades/flame.jpg" alt="flame decal"></div>
     ...
     <div class="flex">
      <a href="#" title="bumper stickers">
       <figure>
        <div class="add-col"><img src="/phpmotors4images/upgrades/bumper_sticker.jpg" alt="Bumper Stickers"> </div>
        <figcaption>Bumper Stickers</figcaption>
       </figure>
      </a>
      <a href="#" title="hub caps">
       <figure>
        <div class="add-col"><img src="/phpmotors4images/upgrades/hub-cap.jpg" alt="Hub Caps"></div>
