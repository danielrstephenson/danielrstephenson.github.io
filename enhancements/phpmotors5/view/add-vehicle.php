    ...
    <div id="wrapper">
      ...
      <main>
        ...
        <form action="/phpmotors5/vehicles/" method="post">
          ...
          <input type="text" name="invImage" id="invImage" value="/phpmotors5/images/no-image.png" required
            <?php if (isset($invImage)) {
              echo "value='$invImage'";
            } ?>>

          <label for="invThumbnail">Thumbnail Path</label>
          <input type="text" name="invThumbnail" id="invThumbnail" value="/phpmotors5/images/no-image.png" required
